    ...
    return (
        <footer className="bg-slate-100 dark:bg-[#030712] pt-20 pb-10 border-t border-slate-200 dark:border-white/5 transition-colors duration-500">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                {/* Links Column */}
                <div>
                    <h4 className="text-zinc-800 font-bold mb-6">Quick Links</h4>
                ...
                {/* Newsletter */}
                <div>
                    <h4 className="text-zinc-800 font-bold mb-6">Newsletter</h4>
                    <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">Get the latest car releases in your inbox.</p>
                    <div className="flex gap-2">
                        <input type="email" placeholder="Email" className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-2 text-sm w-full outline-none focus:ring-1 focus:ring-cyan-500" />
